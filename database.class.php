...
class SqlStatement
{
    ...
    /**
     * @param string|array $columns the columns to be selected, can be passed as String or Array
     * @return \MhDb\SqlStatement
     */
    ...
    /**
     * @param array $update data to be set in update expression
     * @return \MhDb\SqlStatement
     */
    ...
    /**
     * @param string|array $tables tables to delete from
     * @return \MhDb\SqlStatement
     */
     ...
     * @param array $columns array of columns to be inserted
     * @return \MhDb\SqlStatement
     */
    ...
    /**
     * @param array $valuesArgs array of values to be inserted into table
     * @return \MhDb\SqlStatement
     */
    ...
    /**
     * @param string $column
     * @param string $operator typical operators like =, =<, >=, !=
     * @param string $value
     * @return \MhDb\SqlStatement
     */
